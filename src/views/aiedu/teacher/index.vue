<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['aiedu:teacher:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['aiedu:teacher:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="教师图片" align="center" prop="imageUrl" width="100">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['aiedu:teacher:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['aiedu:teacher:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="teacherRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="教师图片" prop="imageUrl">
...
import { listTeacher, getTeacher, delTeacher, addTeacher, updateTeacher } from "@/api/aiedu/teacher";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除教师编号为"' + _teacherIds + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('aiedu/teacher/export', {
    ...queryParams.value
